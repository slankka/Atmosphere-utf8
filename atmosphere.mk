...
ATMOSPHERE_PACKAGE_REVISION := $(subst /,-,$(ATMOSPHERE_GIT_REVISION))
ATMOSPHERE_VERSION := $(ATMOSPHERE_MAJOR_VERSION).$(ATMOSPHERE_MINOR_VERSION).$(ATMOSPHERE_MICRO_VERSION)-$(ATMOSPHERE_PACKAGE_REVISION)
